...
class RoadmapSchema(BaseModel):
    ...
    generation_source: Literal["llm", "deterministic_fallback"] = Field(
        default="llm",
        description="Indicates whether the roadmap was generated by the LLM or deterministic fallback",
    )
